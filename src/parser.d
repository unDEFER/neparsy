...
class Parser
{
    ...
    Expression[] getVar()
    {
        ...
        Expression[]  pp;
        Init:
        if (lexer == "static"         || lexer == "override"         || lexer == "public"         || lexer == "private"         || lexer == "package"         || lexer == "protected")
        {
    ...
    Expression[] getStatement()
    {
        ...
        else if (lexer == "break"         || lexer == "continue")
        {
            Expression expr = new Expression;
        ...
        else if (lexer == "case"         || lexer == "default"         || lexer == "}")
        {
            lexer = back;
            return null;
        }
        else if (lexer == LexemType.Identifier)
        {
            ...
            Name:
            getLexem;
            if (lexer == "."             || lexer == "="             || lexer == "++"             || lexer == "--"             || lexer == "(")
            {
                lexer = back;
    ...
    Expression[] getArguments()
    {
        ...
        else if (lexer == "in"         || lexer == "out"         || lexer == "ref")
        {
            Expression expr = new Expression;
            expr.operator = lexer.lexem;
            post ~= expr;
    ...
    Expression getExpression()
    {
        ...
        else if (lexer == LexemType.String         || lexer == LexemType.Number         || lexer == LexemType.Float         || lexer == LexemType.Character         || lexer == LexemType.LenOperator)
        {
            Expression arg = new Expression;
            arg.operator = lexer.lexem;
            ed.addChild(arg);
        ...
        Operator:
        if (lexer == "."         || lexer == "?"         || lexer == ":"         || lexer == "in"         || lexer == "is"         || lexer == LexemType.AssignOperator         || lexer == LexemType.CmpOperator         || lexer == LexemType.Operator)
        {
            string op2 = lexer.lexem;
            if (op2 == "!")
            {
                getLexem;
                if (lexer == "is"                 || lexer == "in")
                {
                    op2 ~= lexer.lexem;
                }
                else
